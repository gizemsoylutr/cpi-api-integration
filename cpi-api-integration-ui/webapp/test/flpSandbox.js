		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cpiapiintegrationui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cpiapiintegrationui-display": {
								"semanticObject": "cpiapiintegrationui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cpiapiintegrationui",
									"url": sap.ui.require.toUrl("cpiapiintegrationui")
								}
							}
						}
					}
